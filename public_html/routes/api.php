...
// Rotas da Automação IntegraX
Route::prefix('automacao-integrax')->group(function () {
    Route::get('/', [App\Http\Controllers\Api\AutomacaoIntegraXController::class, 'show']);
    Route::post('/', [App\Http\Controllers\Api\AutomacaoIntegraXController::class, 'store']);
    Route::post('/activate', [App\Http\Controllers\Api\AutomacaoIntegraXController::class, 'activate']);
    Route::post('/deactivate', [App\Http\Controllers\Api\AutomacaoIntegraXController::class, 'deactivate']);
    Route::get('/status', [App\Http\Controllers\Api\AutomacaoIntegraXController::class, 'status']);
});
