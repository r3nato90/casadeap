...
use App\Traits\Gateways\VersellPayTrait;
...
{
    use SuitpayTrait, DigitoPayTrait, EzzepayTrait, BsPayTrait, OndaPayTrait, WishPagTrait, VersellPayTrait;
    ...
    public function submitPayment(Request $request)
    {
        ...
        switch ($request->gateway) {
            ...
            case 'versellpay':
                return self::requestQrcodeVersellPay($request);
        }
    }
