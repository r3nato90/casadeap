...
use App\Filament\Pages\AutomacaoIntegraXPage;
                ...
                return $builder->groups([
                    ...
                    NavigationGroup::make('DEFINIÇÕES DA PLATAFORMA')
                        ->items([
                            ...
                            NavigationItem::make('setting-mail')
                                ...
                                ->isActiveWhen(fn () => request()->routeIs('filament.admin.pages.setting-mail-page')),


                                NavigationItem::make('automacao-integrax')
                                ->icon('heroicon-o-inbox-stack')
                                ->label(fn (): string => 'RECUPERAÇÃO E AUTOMAÇÃO')
                                ->url(fn (): string => AutomacaoIntegraXPage::getUrl())
                                ->isActiveWhen(fn () => request()->routeIs('filament.admin.pages.automacao-integrax')),
                        ]),
                    ...
                    ->items([
                        ...
                        ...VipResource::getNavigationItems(),
                         NavigationItem::make('rounds-free')
                                ...
                                ->isActiveWhen(fn () => request()->routeIs('filament.admin.pages.rounds-free')),
                        ]),
                    ...
                    NavigationGroup::make('GESTÃO DA PLATAFORMA')
                        ->items([
                            ...
                            ->isActiveWhen(fn () => request()->routeIs('filament.admin.pages.logs-rounds-free')),
